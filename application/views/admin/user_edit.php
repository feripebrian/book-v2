                  ...
                  <?php echo form_open('admin/dasbor/user_update/'.$row['id'],'role="form"');?>
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <tr>
                          <td>Slider</td>
                          <td><input name="akses[]" value="dasbor/slide" type="checkbox" class="checkbox" 
                            <?php echo $this->konten_model->set_cb('dasbor/slide',$this->uri->segment(4)) ?>> Akses</td>
                        </tr>
                        <tr>
                          <td>Kategori Buku</td>
                        ...
                        <tr>
                          ...
                          <td><input name="akses[]" value="dasbor/kategori_video" type="checkbox" class="checkbox" 
                            <?php echo $this->konten_model->set_cb('dasbor/kategori_video',$this->uri->segment(4)) ?>> Akses</td>
                        </tr>
                        <tr>
                          <td>Galeri</td>
