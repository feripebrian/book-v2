					...
					<div class="box-body">
						<?php foreach ($video_edukasi_edit as $row) { ?>
							...
							<div class="box-body">
								...
								<div class="form-group">
									<label>Embed</label>
									<textarea name="embed" class="form-control" rows="3" cols="100"><?php echo $row['embed'] ?></textarea>
								</div>
								...
								<div class="form-group">
									...
									<div class="radio">
										<label>
											<input type="radio" name="status" id="status1" value="1" <?php $answer = $row['status'];
																																								if ($answer == "1") {
									...
									<div class="radio">
										<label>
											<input type="radio" name="status" id="status2" value="0" <?php $answer = $row['status'];
																																								if ($answer == "0") {
																																									echo 'checked="Correct"';
																																								}
																																								?>>
